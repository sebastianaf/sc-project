...
#if numpy.mean(ESPERA_CLIENTES) == 0:
#	print("\nLa espera fue de 0" )
#else:
#	print("\nLa espera fue más de cero",'%7.2f'%(numpy.mean(ESPERA_CLIENTES)))
...
def prueba(capacity):
	...
	#while capacity < 10 or iteracion0:
		ESPERA_CLIENTES = numpy.array([])
		iteracion0 = False
		capacity = capacity + 1
		#print("Capacity: ",capacity)
		#print("\nEspera",'%7.2f'%(numpy.mean(ESPERA_CLIENTES)))
...
print("Sevidores necesarios para tiempo 0 de espera: ",prueba(0))
